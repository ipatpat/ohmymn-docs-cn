...
### 改进
1. 所有模块的设置选项默认隐藏。包括 MargicAction。点击提示信息展开。再次点击会跳转到对应的使用文档页面。每次重新打开面板会再次隐藏全部选项。
...
- 在 4.0.6 的基础上修复 MN 3.7.19 中无法使用文本选择手势的问题。
...
- 新增 Shortcut 模块，在升级 MN 3.7.19 后，支持快捷键，iPad 也支持，具体设置方法等待教程。
