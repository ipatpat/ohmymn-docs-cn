...
require("./plugin-vue_export-helper.21b42923.js");
require("@vueuse/core");
...
function et(e2) {
  ...
  if ("production" === process.env.NODE_ENV || !e2 || "object" !== Xe(e2))
    return e2;
  if (t2.has(e2))
    return "[Circular]";
  var n2 = t2.add(e2);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/vitepress@1.0.0-alpha.21_tbpndr44ulefs3hehwpi2mkf2y/node_modules/vitepress/dist/client/theme-default/components/VPAlgoliaSearchBox.vue");
